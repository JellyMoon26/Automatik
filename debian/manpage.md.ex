% automatik(SECTION) | User Commands
%
% "February  4 2025"
...
automatik - program to do something

# SYNOPSIS

**automatik** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**automatik** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **automatik** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**automatik** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    automatik. See **foo.conf**(5) for further details.
...
**automatik** provides some return codes, that can be used in scripts:
...
Oscar B <oscar_b@disroot.org>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Oscar B
